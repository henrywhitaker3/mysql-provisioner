...
// MysqlConnectionSpec defines the desired state of MysqlConnection
type MysqlConnectionSpec struct {
	// INSERT ADDITIONAL SPEC FIELDS - desired state of cluster
	// Important: Run "make" to regenerate code after modifying this file

	// Foo is an example field of MysqlConnection. Edit mysqlconnection_types.go to remove/update
...
// MysqlConnectionStatus defines the observed state of MysqlConnection
...
func init() {
	SchemeBuilder.Register(&MysqlConnection{}, &MysqlConnectionList{})
}
